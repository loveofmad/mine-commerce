...
Page({
  ...
  regions: {
    provinces: [
      ...
      { name: '台湾省', cities: [{ name: '台北市', districts: ['中正区', '大同区', '中山区', '松山区', '大安区', '万华区'] }] },
      { name: '香港特别行政区', cities: [{ name: '香港岛', districts: ['中西区', '湾仔区', '东区', '南区'] }, { name: '九龙', districts: ['油尖旺区', '深水埗区', '九龙城区', '黄大仙区', '观塘区'] }, { name: '新界', districts: ['沙田区', '大埔区', '北区', '西贡区', '屯门区', '元朗区', '荃湾区', '葵青区', '离岛区'] }] },
      { name: '澳门特别行政区', cities: [{ name: '澳门半岛', districts: ['花地玛堂区', '花王堂区',  '望德堂区', '风顺堂区'] }, { name: '氹仔', districts: ['嘉模堂区'] }, { name: '路环', districts: ['路氹填海区'] }] }
    ]
  },
  ...
  getCurrentCities() {
    ...
    const provinces = this.regions.provinces
